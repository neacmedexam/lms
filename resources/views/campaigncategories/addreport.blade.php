...
<x-layouts>
    <div class="bg-bgMain w-full p-14 flex flex-col items-center m-auto  h-full lg:h-screen text-sm ">
        ...
        <h1 class=" text-4xl">Add Report</h1>
        <h1 class="font-bold">Category</h1>
            ...
            <div class=" w-full justify-evenly  px-10 py-4 m-auto h-full flex flex-col sm:flex-row items-center ">
                ...
                <div class=" p-4 m-2">
                    <a href="/addreport/fbanalytics" class="h-full w-full flex items-center justify-center hover:scale-[105%] duration-300 transition-all  ">
                ...
                <div class=" p-4 m-2">
                    <a href="/addreport/webacquisition" class="h-full w-full flex items-center justify-center hover:scale-[105%] duration-300 transition-all ">
                ...
                <div class=" p-4 m-2">
                    <a href="/addreport/campaign" class="h-full w-full flex items-center justify-center hover:scale-[105%] duration-300 transition-all ">
