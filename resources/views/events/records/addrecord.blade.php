...
<x-layouts>
    <div class="bg-bgMain w-full p-7 flex flex-col justify-center items-center h-screen lg:h-screen text-sm ">
        ...
        <h1 class="text-3xl px-4 py-2 text-center">{{$events->eventName}}</h1>
        <!--<p class="p-4">Add Participant</p>-->
            ...
            <div class="lg:max-w-[50%] w-full   justify-center p-6 py-10 bg-[#fff] shadow-lg shadow-gray-600">
                ...
                @endif  
                <form method="POST" action="{{route('events.addparticipants')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        ...
                        <input type="text" name="fullName" value="{{old('fullName')}}" placeholder="Full Name" class="px-4 py-2 border border-gray-600 w-full">
                    ...
                    <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        ...
                        <input type="text" name="email" value="{{old('email')}}" placeholder="Email" class="px-4 py-2 border border-gray-600 w-full">
                    ...
                    <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        ...
                        <input type="text" name="contactNumber" value="{{old('contactNumber')}}" placeholder="Contact Number" class="px-4 py-2 border border-gray-600 w-full">
                    ...
                    <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        ...
                        <input type="text" name="statecountry" value="{{old('statecountry')}}" placeholder="PREFERRED STATE/COUNTRY/SERVICE" class="px-4 py-2 border border-gray-600 w-full">
                    ...
                    <div class="flex flex-col justify-center items-center w-full">
                       ...
                       <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        ...
                        <input type="text" name="facebook" value="{{old('eventname')}}" placeholder="Facebook" class="px-4 py-2 border border-gray-600 w-full">
