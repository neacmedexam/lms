...
<x-layouts>
    <div class="bg-bgMain w-full p-7 flex flex-col items-center h-full lg:h-screen text-sm ">
        ...
        <h1 class="text-4xl p-4">Add New Lead Source</h1>
     

      
            <div class="lg:max-w-[50%] w-full p-6 py-10 bg-[#fff] shadow-lg shadow-gray-600">
             
                <form method="POST" action="/settings/services/addnewleadsource" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        <p class="lg:px-4  font-bold lg:w-[29.5%]">Lead Source Name</p>
                        <input type="text" name="leadSourceName"  value="" placeholder="Lead Source name.." class="px-4 py-2 border border-gray-600 w-full">
