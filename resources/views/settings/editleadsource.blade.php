...
<x-layouts>
    <div class="bg-bgMain w-full p-7 flex flex-col items-center h-full lg:h-screen text-sm ">
        ...
        <h1 class="text-4xl p-4">Edit Lead Source</h1>
            ...
            <div class="lg:max-w-[50%] w-full p-6 py-10 bg-[#fff] shadow-lg shadow-gray-600">
                ...
                {{-- edit form --}}
                <form method="POST" action="/settings/leadsource/edit/{{$edit->leadsourceID}}" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        <p class="lg:px-4  font-bold lg:w-[29.5%]">Lead Source ID:</p>
                        <input type="text" disabled name="leadsourceID"   value="{{$edit->leadsourceID}}" placeholder="leadsourceID" class="px-4 py-2 border border-gray-600 w-full">
                    ...
                    <div class="flex flex-col lg:flex-row justify-evenly lg:items-center py-[2px]">
                        <p class="lg:px-4  font-bold lg:w-[29.5%]">Lead Source</p>
                        <input type="text" name="leadSourceName"  value="{{$edit->leadSourceName}}" placeholder="leadSourceName" class="px-4 py-2 border border-gray-600 w-full">
                    
                    </div>
                    <div class="flex flex-col justify-center items-center w-full">
                        @error('leadSourceName')
                            <p class="text-red-600 text-xs whitespace-nowrap">{{$message}}</p>
                        @enderror
                    </div>
